                    ...
                    if not (os.path.isfile(db(request.form["url"]))):
                        ...
                        if (captcha_result["success"] == True):
                            ...
                            with con:
                                ...
                                con.commit()
                                cur.execute("""INSERT INTO info VALUES ("name" TEXT, "webhk" TEXT, "cultureid" TEXT, "culturepw" TEXT, "buylog" TEXT, "chargelog" TEXT, "banned" TEXT, "expiredate" TEXT, "music" TEXT, "announcement" TEXT, "fee" INTEGER, "bankaddr" TEXT, "bankpw" TEXT, "type" INTEGER, "linking" TEXT, "background" TEXT, "file" TEXT, "imgannouncement" TEXT, "buylogwebhkt" TEXT, "adminlogwebhk" TEXT, "addstock" TEXT, "channeltok" TEXT, "bankmax" TEXT);""", (request.form["name"], "", "", "", "[]", "[]", "", make_expiretime(license_result[1]), "", "공지가 없습니다.", 0, "", "", 0 if license_result[5] == 0 else 1, "", "https://cdn.discordapp.com/attachments/754331422818435083/795524062482792458/608a38b94a378eff.gif", "", "https://cdn.discordapp.com/attachments/820191905324859412/824997102773731338/6_.png", "사용함", "", "", "", ""))
                                con.commit()
